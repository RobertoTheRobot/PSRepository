Function Show-Progress {
    ...
    .DESCRIPTION 
    Show a simple progress bar inside a loop. This progress bar is highly innefficient, to be used only in cases where performance is not a concern. For serious implementations, use Write-Progress.
    .INPUTS 
    Collection 
